...
public class ItemArmor extends Item
{
    ...
    public ItemArmor(ArmorMaterial material, int renderIndex, int type)
    {
        this.material = material;
        this.armorType = type;
        this.renderIndex = renderIndex;
        this.damageReduceAmount = material.getDamageReductionAmount(type);
        this.setMaxDamage(material.getDurability(type));
        this.maxStackSize = 1;
    ...
    {
        return this.material != ArmorMaterial.CLOTH ? false : (!p_82816_1_.hasTagCompound() ? false : (!p_82816_1_.getTagCompound().func_150297_b("display", 10) ? false : p_82816_1_.getTagCompound().getCompoundTag("display").func_150297_b("color", 3)));
    }
    ...
    public static enum ArmorMaterial
    {
        ...
        BAUXITE("BAUXITE", 5, 35, new int[]{3, 8, 6, 4}, 8),
        DOLOMITE("DOLOMITE", 6, 37, new int[]{3, 8, 6, 4}, 6),
        KOBALTE("KOBALTE", 7, 39, new int[]{4, 8, 7, 4}, 5),
        DRAGONIUM("DRAGONIUM", 8, 42, new int[]{3, 9, 7, 3}, 4)
        ;
        ...
        private ArmorMaterial(String name, int id, int maxDamageFactor, int[] damageReductionAmountArray, int enchantability)
        {
