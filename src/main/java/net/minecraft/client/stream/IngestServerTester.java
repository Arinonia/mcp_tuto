...
public class IngestServerTester implements IStatCallbacks, IStreamCallbacks
{
    ...
    public static enum IngestTestState
    {
        ...
        private static final IngestTestState[] $VALUES = new IngestTestState[]{Uninitalized, Starting, ConnectingToServer, TestingServer, DoneTestingServer, Finished, Cancelled, Failed};
    ...
    static final class SwitchStatType
    {
        ...
        static final int[] field_153027_b = new int[IngestTestState.values().length];
