...
public class NetworkStatistics
{
    ...
    public static class PacketStat
    {
        ...
        public PacketStat(int p_i1188_1_, PacketStatData p_i1188_2_)
        {
    ...
    static class PacketStatData
    {
        ...
        {
            return new PacketStatData(p_152494_1_ + this.field_152496_a, this.field_152497_b + 1, (double)((p_152494_1_ + this.field_152496_a) / (long)(this.field_152497_b + 1)));
        }
    ...
    static class Tracker
    {
        ...
        public Tracker()
        {
            ...
            {
                this.field_152490_a[var1] = new AtomicReference(new PacketStatData(0L, 0, 0.0D, null));
            }
        }
        ...
        public void func_152488_a(int p_152488_1_, long p_152488_2_)
        {
            try
            {
                ...
                do
                {
                    var4 = (PacketStatData)this.field_152490_a[p_152488_1_].get();
        ...
        public long func_152485_a()
        {
            ...
            {
                var1 += ((PacketStatData)this.field_152490_a[var3].get()).func_152493_a();
            }
        ...
        public long func_152489_b()
        {
            ...
            for (int var3 = 0; var3 < 100; ++var3)
            {
                var1 += (long)((PacketStatData)this.field_152490_a[var3].get()).func_152495_b();
            }
        ...
        {
            int var1 = -1;
            PacketStatData var2 = new PacketStatData(-1L, -1, 0.0D, null);

            for (int var3 = 0; var3 < 100; ++var3)
            {
                PacketStatData var4 = (PacketStatData)this.field_152490_a[var3].get();
        ...
        public PacketStat func_152487_a(int p_152487_1_)
        {
            return p_152487_1_ >= 0 && p_152487_1_ < 100 ? new PacketStat(p_152487_1_, (PacketStatData)this.field_152490_a[p_152487_1_].get()) : null;
        }
    }
}
