...
public class ServerStatusResponse
{
    ...
    public static class Serializer implements JsonDeserializer, JsonSerializer
    {
        ...
        public ServerStatusResponse deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_)
        {
            ...
            if (var4.has("players"))
            {
                var5.func_151319_a((PlayerCountData)p_deserialize_3_.deserialize(var4.get("players"), PlayerCountData.class));
            }

            if (var4.has("version"))
            {
                var5.func_151321_a((MinecraftProtocolVersionIdentifier)p_deserialize_3_.deserialize(var4.get("version"), MinecraftProtocolVersionIdentifier.class));
            }
