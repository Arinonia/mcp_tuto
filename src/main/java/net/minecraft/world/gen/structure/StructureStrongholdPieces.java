...
public class StructureStrongholdPieces
{
     ...
     */
    private static Stronghold getStrongholdComponentFromWeightedPiece(Class p_75200_0_, List p_75200_1_, Random p_75200_2_, int p_75200_3_, int p_75200_4_, int p_75200_5_, int p_75200_6_, int p_75200_7_)
    {
        Object var8 = null;
        ...
        {
            var8 = RightTurn.findValidPlacement(p_75200_1_, p_75200_2_, p_75200_3_, p_75200_4_, p_75200_5_, p_75200_6_, p_75200_7_);
        }
    ...
    private static Stronghold getNextComponent(Stairs2 p_75201_0_, List p_75201_1_, Random p_75201_2_, int p_75201_3_, int p_75201_4_, int p_75201_5_, int p_75201_6_, int p_75201_7_)
    {
        ...
        else
        {
            ...
            {
                Stronghold var8 = getStrongholdComponentFromWeightedPiece(strongComponentType, p_75201_1_, p_75201_2_, p_75201_3_, p_75201_4_, p_75201_5_, p_75201_6_, p_75201_7_);
                strongComponentType = null;
            ...
            while (var13 < 5)
            {
                ...
                while (var10.hasNext())
                {
                    ...
                    if (var9 < 0)
                    {
                        ...
                        Stronghold var12 = getStrongholdComponentFromWeightedPiece(var11.pieceClass, p_75201_1_, p_75201_2_, p_75201_3_, p_75201_4_, p_75201_5_, p_75201_6_, p_75201_7_);
            ...
            StructureBoundingBox var14 = Corridor.func_74992_a(p_75201_1_, p_75201_2_, p_75201_3_, p_75201_4_, p_75201_5_, p_75201_6_);
    ...
    private static StructureComponent getNextValidComponent(Stairs2 p_75196_0_, List p_75196_1_, Random p_75196_2_, int p_75196_3_, int p_75196_4_, int p_75196_5_, int p_75196_6_, int p_75196_7_)
    {
        if (p_75196_7_ > 50)
        {
            return null;
        ...
        {
            Stronghold var8 = getNextComponent(p_75196_0_, p_75196_1_, p_75196_2_, p_75196_3_, p_75196_4_, p_75196_5_, p_75196_6_, p_75196_7_ + 1);
    ...
    public static class ChestCorridor extends Stronghold
    {
        ...
        public static ChestCorridor findValidPlacement(List p_75000_0_, Random p_75000_1_, int p_75000_2_, int p_75000_3_, int p_75000_4_, int p_75000_5_, int p_75000_6_)
        {
            ...
            return canStrongholdGoDeeper(var7) && StructureComponent.findIntersecting(p_75000_0_, var7) == null ? new ChestCorridor(p_75000_6_, p_75000_1_, var7, p_75000_5_) : null;
        }
    ...
    public static class Crossing extends Stronghold
    {
        ...
        public static Crossing findValidPlacement(List p_74994_0_, Random p_74994_1_, int p_74994_2_, int p_74994_3_, int p_74994_4_, int p_74994_5_, int p_74994_6_)
        {
            ...
            return canStrongholdGoDeeper(var7) && StructureComponent.findIntersecting(p_74994_0_, var7) == null ? new Crossing(p_74994_6_, p_74994_1_, var7, p_74994_5_) : null;
        }
    ...
    public static class LeftTurn extends Stronghold
    {
        ...
        public static LeftTurn findValidPlacement(List p_75010_0_, Random p_75010_1_, int p_75010_2_, int p_75010_3_, int p_75010_4_, int p_75010_5_, int p_75010_6_)
        {
            ...
            return canStrongholdGoDeeper(var7) && StructureComponent.findIntersecting(p_75010_0_, var7) == null ? new LeftTurn(p_75010_6_, p_75010_1_, var7, p_75010_5_) : null;
        }
    ...
    public static class Library extends Stronghold
    {
        ...
        public static Library findValidPlacement(List p_75006_0_, Random p_75006_1_, int p_75006_2_, int p_75006_3_, int p_75006_4_, int p_75006_5_, int p_75006_6_)
        {
    ...
    public static class PortalRoom extends Stronghold
    {
        ...
        public static PortalRoom findValidPlacement(List p_75004_0_, Random p_75004_1_, int p_75004_2_, int p_75004_3_, int p_75004_4_, int p_75004_5_, int p_75004_6_)
        {
            ...
            return canStrongholdGoDeeper(var7) && StructureComponent.findIntersecting(p_75004_0_, var7) == null ? new PortalRoom(p_75004_6_, p_75004_1_, var7, p_75004_5_) : null;
        }
    ...
    public static class Prison extends Stronghold
    {
        ...
        public static Prison findValidPlacement(List p_75016_0_, Random p_75016_1_, int p_75016_2_, int p_75016_3_, int p_75016_4_, int p_75016_5_, int p_75016_6_)
        {
            ...
            return canStrongholdGoDeeper(var7) && StructureComponent.findIntersecting(p_75016_0_, var7) == null ? new Prison(p_75016_6_, p_75016_1_, var7, p_75016_5_) : null;
        }
    ...
    public static class RoomCrossing extends Stronghold
    {
        ...
        public static RoomCrossing findValidPlacement(List p_75012_0_, Random p_75012_1_, int p_75012_2_, int p_75012_3_, int p_75012_4_, int p_75012_5_, int p_75012_6_)
        {
            ...
            return canStrongholdGoDeeper(var7) && StructureComponent.findIntersecting(p_75012_0_, var7) == null ? new RoomCrossing(p_75012_6_, p_75012_1_, var7, p_75012_5_) : null;
        }
    ...
    public static class Stairs extends Stronghold
    {
        ...
        public static Stairs getStrongholdStairsComponent(List p_75022_0_, Random p_75022_1_, int p_75022_2_, int p_75022_3_, int p_75022_4_, int p_75022_5_, int p_75022_6_)
        {
            ...
            return canStrongholdGoDeeper(var7) && StructureComponent.findIntersecting(p_75022_0_, var7) == null ? new Stairs(p_75022_6_, p_75022_1_, var7, p_75022_5_) : null;
        }
    ...
    public static class StairsStraight extends Stronghold
    {
        ...
        public static StairsStraight findValidPlacement(List p_75028_0_, Random p_75028_1_, int p_75028_2_, int p_75028_3_, int p_75028_4_, int p_75028_5_, int p_75028_6_)
        {
            ...
            return canStrongholdGoDeeper(var7) && StructureComponent.findIntersecting(p_75028_0_, var7) == null ? new StairsStraight(p_75028_6_, p_75028_1_, var7, p_75028_5_) : null;
        }
    ...
    public static class Straight extends Stronghold
    {
        ...
        public static Straight findValidPlacement(List p_75018_0_, Random p_75018_1_, int p_75018_2_, int p_75018_3_, int p_75018_4_, int p_75018_5_, int p_75018_6_)
        {
            ...
            return canStrongholdGoDeeper(var7) && StructureComponent.findIntersecting(p_75018_0_, var7) == null ? new Straight(p_75018_6_, p_75018_1_, var7, p_75018_5_) : null;
        }
    ...
    abstract static class Stronghold extends StructureComponent
    {
        ...
        protected void placeDoor(World p_74990_1_, Random p_74990_2_, StructureBoundingBox p_74990_3_, Door p_74990_4_, int p_74990_5_, int p_74990_6_, int p_74990_7_)
        {
