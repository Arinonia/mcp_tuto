...
public class StructureNetherBridgePieces
{
    ...
    public static class Corridor extends Piece
    {
        ...
        public static Corridor createValidComponent(List p_74978_0_, Random p_74978_1_, int p_74978_2_, int p_74978_3_, int p_74978_4_, int p_74978_5_, int p_74978_6_)
        {
            ...
            return isAboveGround(var7) && StructureComponent.findIntersecting(p_74978_0_, var7) == null ? new Corridor(p_74978_6_, p_74978_1_, var7, p_74978_5_) : null;
        }
    ...
    public static class Corridor2 extends Piece
    {
        ...
        public static Corridor2 createValidComponent(List p_74980_0_, Random p_74980_1_, int p_74980_2_, int p_74980_3_, int p_74980_4_, int p_74980_5_, int p_74980_6_)
        {
            ...
            return isAboveGround(var7) && StructureComponent.findIntersecting(p_74980_0_, var7) == null ? new Corridor2(p_74980_6_, p_74980_1_, var7, p_74980_5_) : null;
        }
    ...
    public static class Corridor3 extends Piece
    {
        ...
        public static Corridor3 createValidComponent(List p_74982_0_, Random p_74982_1_, int p_74982_2_, int p_74982_3_, int p_74982_4_, int p_74982_5_, int p_74982_6_)
        {
            ...
            return isAboveGround(var7) && StructureComponent.findIntersecting(p_74982_0_, var7) == null ? new Corridor3(p_74982_6_, p_74982_1_, var7, p_74982_5_) : null;
        }
    ...
    public static class Corridor4 extends Piece
    {
        ...
        public static Corridor4 createValidComponent(List p_74985_0_, Random p_74985_1_, int p_74985_2_, int p_74985_3_, int p_74985_4_, int p_74985_5_, int p_74985_6_)
        {
            ...
            return isAboveGround(var7) && StructureComponent.findIntersecting(p_74985_0_, var7) == null ? new Corridor4(p_74985_6_, p_74985_1_, var7, p_74985_5_) : null;
        }
    ...
    public static class Corridor5 extends Piece
    {
        ...
        public static Corridor5 createValidComponent(List p_74981_0_, Random p_74981_1_, int p_74981_2_, int p_74981_3_, int p_74981_4_, int p_74981_5_, int p_74981_6_)
        {
            ...
            return isAboveGround(var7) && StructureComponent.findIntersecting(p_74981_0_, var7) == null ? new Corridor5(p_74981_6_, p_74981_1_, var7, p_74981_5_) : null;
        }
    ...
    public static class Crossing extends Piece
    {
        ...
        public static Crossing createValidComponent(List p_74974_0_, Random p_74974_1_, int p_74974_2_, int p_74974_3_, int p_74974_4_, int p_74974_5_, int p_74974_6_)
        {
            ...
            return isAboveGround(var7) && StructureComponent.findIntersecting(p_74974_0_, var7) == null ? new Crossing(p_74974_6_, p_74974_1_, var7, p_74974_5_) : null;
        }
    ...
    public static class Crossing2 extends Piece
    {
        ...
        public static Crossing2 createValidComponent(List p_74979_0_, Random p_74979_1_, int p_74979_2_, int p_74979_3_, int p_74979_4_, int p_74979_5_, int p_74979_6_)
        {
            ...
            return isAboveGround(var7) && StructureComponent.findIntersecting(p_74979_0_, var7) == null ? new Crossing2(p_74979_6_, p_74979_1_, var7, p_74979_5_) : null;
        }
    ...
    public static class Crossing3 extends Piece
    {
        ...
        public static Crossing3 createValidComponent(List p_74966_0_, Random p_74966_1_, int p_74966_2_, int p_74966_3_, int p_74966_4_, int p_74966_5_, int p_74966_6_)
        {
            ...
            return isAboveGround(var7) && StructureComponent.findIntersecting(p_74966_0_, var7) == null ? new Crossing3(p_74966_6_, p_74966_1_, var7, p_74966_5_) : null;
        }
    ...
    public static class End extends Piece
    {
        ...
        public static End func_74971_a(List p_74971_0_, Random p_74971_1_, int p_74971_2_, int p_74971_3_, int p_74971_4_, int p_74971_5_, int p_74971_6_)
        {
            ...
            return isAboveGround(var7) && StructureComponent.findIntersecting(p_74971_0_, var7) == null ? new End(p_74971_6_, p_74971_1_, var7, p_74971_5_) : null;
        }
    ...
    public static class Entrance extends Piece
    {
        ...
        public static Entrance createValidComponent(List p_74984_0_, Random p_74984_1_, int p_74984_2_, int p_74984_3_, int p_74984_4_, int p_74984_5_, int p_74984_6_)
        {
            ...
            return isAboveGround(var7) && StructureComponent.findIntersecting(p_74984_0_, var7) == null ? new Entrance(p_74984_6_, p_74984_1_, var7, p_74984_5_) : null;
        }
    ...
    public static class NetherStalkRoom extends Piece
    {
        ...
        public static NetherStalkRoom createValidComponent(List p_74977_0_, Random p_74977_1_, int p_74977_2_, int p_74977_3_, int p_74977_4_, int p_74977_5_, int p_74977_6_)
        {
            ...
            return isAboveGround(var7) && StructureComponent.findIntersecting(p_74977_0_, var7) == null ? new NetherStalkRoom(p_74977_6_, p_74977_1_, var7, p_74977_5_) : null;
        }
    ...
    abstract static class Piece extends StructureComponent
    {
            ...
            while (var12 < 5 && var11)
            {
                ...
                while (var14.hasNext())
                {
                    ...
                    if (var13 < 0)
                    {
                        ...
                        Piece var16 = StructureNetherBridgePieces.createNextComponentRandom(var15, p_74959_3_, p_74959_4_, p_74959_5_, p_74959_6_, p_74959_7_, p_74959_8_, p_74959_9_);
        ...
        private StructureComponent getNextComponent(Start p_74962_1_, List p_74962_2_, Random p_74962_3_, int p_74962_4_, int p_74962_5_, int p_74962_6_, int p_74962_7_, int p_74962_8_, boolean p_74962_9_)
        {
            if (Math.abs(p_74962_4_ - p_74962_1_.getBoundingBox().minX) <= 112 && Math.abs(p_74962_6_ - p_74962_1_.getBoundingBox().minZ) <= 112)
            {
                ...
                Piece var11 = this.getNextComponent(p_74962_1_, var10, p_74962_2_, p_74962_3_, p_74962_4_, p_74962_5_, p_74962_6_, p_74962_7_, p_74962_8_ + 1);
    ...
    public static class Stairs extends Piece
    {
        ...
        public static Stairs createValidComponent(List p_74973_0_, Random p_74973_1_, int p_74973_2_, int p_74973_3_, int p_74973_4_, int p_74973_5_, int p_74973_6_)
        {
            ...
            return isAboveGround(var7) && StructureComponent.findIntersecting(p_74973_0_, var7) == null ? new Stairs(p_74973_6_, p_74973_1_, var7, p_74973_5_) : null;
        }
    ...
    public static class Straight extends Piece
    {
        ...
        public static Straight createValidComponent(List p_74983_0_, Random p_74983_1_, int p_74983_2_, int p_74983_3_, int p_74983_4_, int p_74983_5_, int p_74983_6_)
        {
            ...
            return isAboveGround(var7) && StructureComponent.findIntersecting(p_74983_0_, var7) == null ? new Straight(p_74983_6_, p_74983_1_, var7, p_74983_5_) : null;
        }
    ...
    public static class Throne extends Piece
    {
        ...
        public static Throne createValidComponent(List p_74975_0_, Random p_74975_1_, int p_74975_2_, int p_74975_3_, int p_74975_4_, int p_74975_5_, int p_74975_6_)
        {
            ...
            return isAboveGround(var7) && StructureComponent.findIntersecting(p_74975_0_, var7) == null ? new Throne(p_74975_6_, p_74975_1_, var7, p_74975_5_) : null;
        }
