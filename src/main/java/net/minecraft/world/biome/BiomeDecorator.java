...
public class BiomeDecorator
{
    ...
    protected WorldGenerator dragoniumGen;
    ...
    public BiomeDecorator()
    {
        ...
        this.bauxiteGen = new WorldGenMinable(Blocks.bauxite_ore, 6);
        this.dolomiteGen = new WorldGenMinable(Blocks.dolomite_ore, 6);
        this.kobalteGen = new WorldGenMinable(Blocks.kobalte_ore, 6);
        this.dragoniumGen = new WorldGenMinable(Blocks.dragonium_ore, 6);
    ...
    protected void generateOres()
    {
        ...
        this.genStandardOre1(1, this.bauxiteGen, 0, 16);
        this.genStandardOre1(1, this.dolomiteGen, 0, 14);
        this.genStandardOre1(1, this.kobalteGen, 0, 14);
        this.genStandardOre1(1, this.dragoniumGen, 0, 12);
