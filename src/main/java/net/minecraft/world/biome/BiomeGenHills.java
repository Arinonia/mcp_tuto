...
public class BiomeGenHills extends BiomeGenBase
{
    ...
    public void decorate(World p_76728_1_, Random p_76728_2_, int p_76728_3_, int p_76728_4_)
    {
        ...
        int rdmBedrock = 3 + p_76728_2_.nextInt(6);
        for (var6 = 0; var6 < rdmBedrock; ++var6)
        {
            var7 = p_76728_3_ + p_76728_2_.nextInt(16);
            var8 = p_76728_2_.nextInt(20) + 4;
            int var9 = p_76728_4_ + p_76728_2_.nextInt(16);

            if (p_76728_1_.getBlock(var7, var8, var9) == Blocks.stone)
            {
                p_76728_1_.setBlock(var7, var8, var9, Blocks.bedrock, 0, 2);
                p_76728_1_.setBlock(var7 + p_76728_2_.nextInt(2), var8, var9, Blocks.bedrock, 0, 2);
                p_76728_1_.setBlock(var7  + p_76728_2_.nextInt(2), var8, var9, Blocks.bedrock, 0, 2);
                p_76728_1_.setBlock(var7 + p_76728_2_.nextInt(2), var8, var9  + p_76728_2_.nextInt(2), Blocks.bedrock, 0, 2);
