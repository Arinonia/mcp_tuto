...
public class WeightedRandom
{
     ...
     */
    public static int getTotalWeight(Item[] p_76270_0_)
    {
        int var1 = 0;
        Item[] var2 = p_76270_0_;
     ...
     */
    public static Item getRandomItem(Random p_76269_0_, Item[] p_76269_1_, int p_76269_2_)
    {
        if (p_76269_2_ <= 0)
        {
            throw new IllegalArgumentException();
     ...
     * Returns a random choice from the input items.
     */
    public static Item getRandomItem(Random p_76274_0_, Item[] p_76274_1_)
    {
