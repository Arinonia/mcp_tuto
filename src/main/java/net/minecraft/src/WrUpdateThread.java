...
public class WrUpdateThread extends Thread
{
    ...
    public void run()
    {
        ...
        ThreadUpdateListener updateListener = new ThreadUpdateListener((NamelessClass1832134939)null);
    ...
    private class ThreadUpdateControl implements IWrUpdateControl
    {
        ...
        ThreadUpdateControl(NamelessClass1832134939 x1)
        {
            this();
        }
    }
    ...
    private class ThreadUpdateListener implements IWrUpdateListener
    {
        ...
        {
            this.tuc = WrUpdateThread.this.new ThreadUpdateControl((NamelessClass1832134939)null);
        }
        ...
        ThreadUpdateListener(NamelessClass1832134939 x1)
        {
            this();
        }
    }
