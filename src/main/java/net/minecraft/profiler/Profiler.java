...
public class Profiler
{
    ...
    public List getProfilingData(String par1Str)
    {
        ...
        else
        {
            ...
            {
                var7.add(new Result("unspecified", (double)((float)var8 - var201) * 100.0D / (double)var8, (double)((float)var8 - var201) * 100.0D / (double)var3));
            }
    ...
    public static final class Result implements Comparable
    {
        ...
        public int compareTo(Result par1Obj)
        {
